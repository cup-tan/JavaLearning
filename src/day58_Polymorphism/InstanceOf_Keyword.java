...
public class InstanceOf_Keyword {
    ...
    public static void main(String[] args) {
        ...
        Animal animal2 = new Dog("Winston", 3, 'M');// sub class
        Animal animal3 = new Cat("Maya", 2, 'F');
        ...
        Cylinder a3 = new Cylinder(2,5);
        Cylinder a4 = new Cylinder(2,5);

        System.out.println(equalShapes(a3, a4));
    }
