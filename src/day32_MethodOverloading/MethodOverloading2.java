...
public class MethodOverloading2 {
    ...
    public static void addition(double a,  double b, double c){// must be different argument
        System.out.println(a+b+c);
    }

    public static void addition(double a, double b, double c, double d){
        System.out.println(a+b+c+d);// we just memorize one name // it is a advantage of overloading method
        // reusable
    }
