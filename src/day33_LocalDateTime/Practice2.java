...
public class Practice2 {
    ...
    public static void main(String[] args) {
       ...
       // Odina : May/23/5   Monday

    for (int i =0 ; i <= students.length-1; i++){
        System.out.println(students[i]+" : "+ birthDays[i].format(dateFormat));
    }
    /*
    kalbinur Kaherman : December/26/82 Sunday
    Virginia Truba : November/25/93 Thursday
    Odina : May/23/80 Friday
    Ernis : February/21/90 Wednesday
    Isa : November/28/82 Sunday
     */
