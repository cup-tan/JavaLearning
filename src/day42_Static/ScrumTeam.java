...
public class ScrumTeam {
    ...
    public void addTester(Tester[] testers){ // if local variable  called same with instance , use this keyword
       if (testers.length == 0){
           return;
       }
    ...
    public void addDeveloper(Developer developer){ // no local variable
        developers.add(developer);
    }

    public void addDeveloper(Developer[] developers){ // overloading method's parameter must be different
    ...
    public void removeDeveloper(long employeeID){
        developers.removeIf( p -> p.employeeID == employeeID); // remove from Arraylist
